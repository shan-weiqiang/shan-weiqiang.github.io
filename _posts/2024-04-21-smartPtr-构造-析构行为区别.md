---
layout: post
title:  "smartPtr构造-析构行为区别"
date:   2024-04-21 12:22:46 +0800
tags: [C++]
---

在[smart ptr内存模型](https://shan-weiqiang.github.io/2024/04/20/shared_ptr-%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B.html)文章中，介绍了`std::shared_ptr`和`std::unique_ptr`的内存模型区别，这篇文章介绍它们的构造和析构的行为区别。
...
在[pimpl设计模式unique_ptr编译问题分析](https://shan-weiqiang.github.io/2023/12/24/pimpl%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8Funique_ptr%E7%BC%96%E8%AF%91%E9%97%AE%E9%A2%98%E5%88%86%E6%9E%90.html)，对`std::unique_ptr`的`incomplete type`问题做了全面的分析。
